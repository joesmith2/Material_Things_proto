...
public class ParseQueryAdapter<T extends ParseObject> extends BaseAdapter {
  ...
  /**
   * Implement to construct your own custom {@link com.parse.ParseQuery} for fetching objects.
   */
  ...
  /**
   * Constructs a {@code ParseQueryAdapter}. Given a {@link com.parse.ParseObject} subclass, this adapter will
   * fetch and display all {@link com.parse.ParseObject}s of the specified class, ordered by creation time.
   *
   * @param context
   *          The activity utilizing this adapter.
   * @param clazz
   *          The {@link com.parse.ParseObject} subclass type to fetch and display.
   */
   ...
   *          The activity utilizing this adapter.
   * @param className
   *          The name of the Parse class of {@link com.parse.ParseObject}s to display.
   */
   ...
   * {@link com.parse.ParseQuery} to be used when fetching items from Parse.
   *
   * @param context
   *          The activity utilizing this adapter.
   * @param queryFactory
   *          A {@link com.parse.ParseQueryAdapter.QueryFactory} to build a {@link com.parse.ParseQuery} for fetching objects.
   */
  ...
  /**
   * Overrides {@link android.widget.Adapter#getCount()} method to return the number of cells to
  ...
  /**
   * Override this method to customize each cell given a {@link com.parse.ParseObject}.
   * <p/>
   ...
   * {@link #setTextKey(String)}) and an image (described by a {@link com.parse.ParseFile}, under the key set
   * via {@link #setImageKey(String)}) if applicable. If the text key is not set, the value for
   * {@link com.parse.ParseObject#getObjectId()} will be displayed instead.
   *
   * @param object
   *          The {@link com.parse.ParseObject} associated with this item.
   * @param v
   ...
   * @return The customized view displaying the {@link com.parse.ParseObject}'s information.
   */
   ...
   * {@link #getNextPageView(android.view.View, android.view.ViewGroup)} and
   * {@link #getItemView(com.parse.ParseObject, android.view.View, android.view.ViewGroup)} depending on the value of
   ...
   * @param query
   *          the {@link com.parse.ParseQuery} used to fetch items from Parse. This query will be mutated and
